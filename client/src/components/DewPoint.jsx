      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="relative w-20 h-20 shrink-0">
          <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
            ...
            <path d="M18 2.08 a 15.92 15.92 0 0 1 0 31.83 a 15.92 15.92 0 0 1 0 -31.83" fill="none" stroke={comfort.color} strokeWidth="2.5" strokeDasharray={`${comfort.score}, 100`} strokeLinecap="round" className="transition-all duration-1000" />
          </svg>
